...
// ── Datos crudos de negocio (dashboard Inicio) ────────────
// Carga wa_orders + cart_quotes (mismo patrón que TabDespachos: sin canal
// realtime, con `reload` manual). El cálculo de agregados/filtros vive en
// TabInicio, que es quien conoce el rango de fecha y estado elegidos.
export function useOrdersStats() {
  ...
  return { orders, quotes, loading, reload: load };
}
