/* VETA · panel de "tweaks" flotante (modo edición) + controles de formulario.
   Shell arrastrable con estilos propios inyectados y un juego de controles
   (slider, radio segmentado, color, texto, botón) reutilizables. Se activa por
   postMessage desde el host de edición. */
